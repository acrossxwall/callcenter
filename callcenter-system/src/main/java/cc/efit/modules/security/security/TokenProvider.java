...
public class TokenProvider implements InitializingBean {
    ...
    public static final String AUTHORITIES_ORG_ID_KEY = "orgId";
    public static final String AUTHORITIES_DEPT_ID_KEY = "deptId";
    ...
    public void afterPropertiesSet() {
        ...
        jwtParser = Jwts.parser()
                .verifyWith(signingKey) // 使用预生成的签名密钥
                .build();
    }
    ...
    public String createToken(JwtUserDto user) {
        ...
        if (user.getUser().getDept()!=null) {
            claims.put(AUTHORITIES_DEPT_ID_KEY, user.getUser().getDept().getId());
        }
        claims.put(AUTHORITIES_ORG_ID_KEY, user.getUser().getOrgId());
        claims.put("userType", user.getUser().getUserType());
