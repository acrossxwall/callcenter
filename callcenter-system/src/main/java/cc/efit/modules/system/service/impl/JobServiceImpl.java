...
import cc.efit.modules.system.service.mapstruct.JobMapper;
...
public class JobServiceImpl implements JobService {
    ...
    public void create(Job resources) {
        ...
        if(job != null){
            throw new EntityExistException("岗位名称已存在");
        }
    ...
    public void delete(Set<Integer> ids) {
        for (Integer id : ids) {
            jobRepository.logicDeleteById(id);
        }
        // 删除缓存
    ...
    public void download(List<JobDto> jobDtos, HttpServletResponse response) throws IOException {
        ...
        for (JobDto jobDTO : jobDtos) {
            ...
            map.put("岗位状态", CommonStatusEnum.ENABLE.getCode().equals(jobDTO.getStatus())? "启用" : "停用");
    ...
    @Override
    public List<JobDto> queryEnableAllJob() {
        return jobMapper.toDto(jobRepository.findByStatus(CommonStatusEnum.ENABLE.getCode()));
    }
