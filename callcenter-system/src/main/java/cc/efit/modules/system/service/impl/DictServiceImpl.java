...
import cc.efit.modules.system.service.mapstruct.DictMapper;
...
public class DictServiceImpl implements DictService {
    ...
    public void update(Dict resources) {
        ...
        dict.setDictType(resources.getDictType());
    ...
    public void delete(Set<Integer> ids) {
        ...
        for (Dict dict : dicts) {
            delCaches(dict);
            dictRepository.logicDeleteById(dict.getId());
        }
    }
...
//            }
    ...
    @Override
    public DictDto findById(Integer id) {
        return dictRepository.findById(id).map(dictMapper::toDto).orElse(null);
    }
