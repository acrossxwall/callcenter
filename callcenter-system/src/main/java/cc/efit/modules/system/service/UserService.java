...
public interface UserService {
     ...
     * @return /
     */
    PageResult<UserInfoDto> queryAll(UserQueryCriteria criteria, Pageable pageable);
    ...
    void updateUserLoginInfo(String username, String ip);

    void updateUserStatus(User resources);

    void deleteUserByOrgId(Integer orgId);
