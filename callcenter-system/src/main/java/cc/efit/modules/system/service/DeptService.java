...
public interface DeptService {
     ...
     * @return /
     */
    Set<Dept> findByRoleId(Integer id);
     ...
     * @return /
     */
    List<DeptInfoDto> buildTree(Integer pid);

    List<DeptInfoDto> buildTreeChildren(Integer pid);
     ...
     * @return /
     */
    List<Integer> getDeptChildren(List<Dept> deptList);
