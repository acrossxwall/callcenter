...
import cc.efit.modules.maint.repository.DeployRepository;
import cc.efit.modules.maint.service.DeployHistoryService;
import cc.efit.modules.maint.service.DeployService;
import cc.efit.modules.maint.service.ServerDeployService;
...
import cc.efit.modules.maint.service.dto.ServerDeployDto;
import cc.efit.modules.maint.service.mapstruct.DeployMapper;
import cc.efit.modules.maint.util.ExecuteShellUtil;
import cc.efit.modules.maint.util.ScpClientUtil;
...
public class DeployServiceImpl implements DeployService {
	...
	@Override
	public DeployDto findById(Integer id) {
	...
	public void delete(Set<Integer> ids) {
		for (Integer id : ids) {
			deployRepository.logicDeleteById(id);
		}
	}
	...
	public String serverReduction(DeployHistory resources) {
		Integer deployId = resources.getDeployId();
