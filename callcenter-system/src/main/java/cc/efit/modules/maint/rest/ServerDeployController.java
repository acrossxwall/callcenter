...
public class ServerDeployController {
    ...
    @PreAuthorize("@cc.check('system:serverDeploy:list')")
    ...
    @PostMapping
    @PreAuthorize("@cc.check('system:serverDeploy:add')")
    ...
    @PutMapping
    @PreAuthorize("@cc.check('system:serverDeploy:edit')")
    ...
    @DeleteMapping
    @PreAuthorize("@cc.check('system:serverDeploy:remove')")
    public ResponseEntity<Object> deleteServerDeploy(@RequestBody Set<Integer> ids){
