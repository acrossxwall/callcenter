...
public class DatabaseController {
    ...
    @PostMapping
	@PreAuthorize("@cc.check('system:database:add')")
    ...
    @PutMapping
	@PreAuthorize("@cc.check('system:database:edit')")
    ...
    @DeleteMapping
	@PreAuthorize("@cc.check('system:database:remove')")
	...
	@PreAuthorize("@cc.check('system:database:testConnect')")
