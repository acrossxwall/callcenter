...
public class FileUtil extends cn.hutool.core.io.FileUtil {
    ...
    public static File upload(MultipartFile file, String filePath) {
        ...
        String nowStr = "-" + SnowflakeUtils.nextId();
        try {
    ...
    public static String getFileType(String type) {
        ...
        String zip = "zip tar gz bz2 rar 7z 7zip";
    ...
    public static String getFileNameByPath(String filePath) {
        return getFileNameByPath(filePath,"/");
    }

    public static String getFileNameByPath(String filePath,String separator) {
        if (StringUtils.isBlank(filePath)) {
            return null;
        }
        if (filePath.contains(separator)) {
            filePath = filePath.substring(filePath.lastIndexOf(separator) + 1);
        }
        return filePath;
    }
}
