 ...
 */
package cc.efit.common.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public R authorizationDeniedException(AuthorizationDeniedException e) {
        log.error(ThrowableUtil.getStackTrace(e));
        return buildResponseEntity(ApiError.error(BAD_REQUEST.value(),"权限不足，请联系管理员"));
    }
    ...
    private R buildResponseEntity(ApiError apiError) {
        return R.error(apiError.getCode(), apiError.getMsg());
    }
}
