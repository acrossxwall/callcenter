...
public class RedisUtils {
    ...
    public <T> T get(String key, Class<T> clazz) {
        ...
        if (!clazz.isInstance(value)) {
            ...
            return JsonUtils.parseObject(JsonUtils.toJsonString(value) , clazz);
    ...
    public <K,V> boolean  hsetAll(String key, Map<K, V> value ) {
        return hsetAll(key, value, -1);
    }

    public <K,V> boolean  hsetAll(String key, Map<K, V> value, long time) {
        try {
    ...
    public long sSet(String key, Object... values) {
        try {
            ...
            log.error("添加redis set 失败:"+key, e);
            return 0;
        }
    }
     ...
     * @param ids    id
     */
    public void delByKeys(String prefix, Set<Integer> ids) {
