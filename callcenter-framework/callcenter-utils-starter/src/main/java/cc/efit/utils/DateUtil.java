...
public class DateUtil {
    ...
    public static final DateTimeFormatter DFY_HOURS = DateTimeFormatter.ofPattern("HH:00");
    ...
    public static String getCurrentTimeString(){
        return localDateTimeFormatyMdHms(LocalDateTime.now());
    }
    ...
    public static String getToday() {
        return localDateTimeFormatYMd(LocalDateTime.now() );
    }


    public static String getTodayHours() {
        return DFY_HOURS.format(LocalDateTime.now() );
    }
